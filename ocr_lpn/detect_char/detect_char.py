...
class char_ocr:
    def __init__(self,device=torch.device("cuda")):
        ...
        self.device=device
        self.load_model()
        self.maps1={'0': 0, '1': 1, '10': 2, '11': 3, '12': 4, '13': 5, '14': 6, '15': 7, '16': 8, '17': 9, '18': 10, '19': 11, '2': 12, '20': 13, '21': 14, '3': 15, '4': 16, '5': 17, '6': 18, '7': 19, '8': 20, '9': 21}
    ...
    def create_model(self, output_dim: int = 22) -> nn.Module:
    ...
    def load_model(self):
        ...
        self.model.load_state_dict(torch.load(os.path.join(path_cur,'weights/char_last.pth')))
        self.model.eval()
    ...
    def predict(self,data):
        ...
        return texts
    def predict_single(self,img_torch): #image PIL
        output=F.softmax(self.model(img_torch.to(self.device)))
        return self.maps[self.maps1[int(output.argmax(1))]],float(torch.max(output))
